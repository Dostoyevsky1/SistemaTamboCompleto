# Manual de Usuario - Sistema Tambo

Bienvenido al manual oficial de usuario del **Sistema Tambo (Gestión de Inventario y Pedidos)**. Este documento te guiará paso a paso sobre cómo interactuar con el sistema de manera rápida y eficiente.
